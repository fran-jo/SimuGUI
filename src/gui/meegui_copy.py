...
class MainGUI(JPanel, PropertyChangeListener):
    '''
...
#         c.gridwidth = 1
        ...
        c2.gridx = 0
        c2.gridy = 1
        pconfig.add(self.radioBtnOMC, c2)
        ...
        c3.gridx = 1
        c3.gridy = 1
        pconfig.add(self.radioBtnJM, c3)
        ...
        c4.gridx = 2
        c4.gridy = 1
        pconfig.add(self.radioBtnDY, c4)
        ...
        c.gridx = 3
        c.gridy = 3
        pconfig.add(self.cbalgorithm, c)
        ''' fila 4 '''
        ...
        c.gridx = 1
        c.gridy = 4
        pconfig.add(self.txtinterval, c)
        ''' fila 5 '''
        ...
        c.gridx = 1
        c.gridy = 5
        pconfig.add(self.txttolerance, c)
        ''' fila 6 '''
        ...
        c.gridx = 1
        c.gridy = 6
        pconfig.add(self.cboutformat, c)
        ...
        c.gridx = 3
        c.gridy = 6
        pconfig.add(self.cbinitialize, c)
        ''' fila 7 '''
        ...
        c.gridx = 2
        c.gridy = 7
        pconfig.add(self.bSimulation, c)
        ''' fila 8 '''
        simProgress= JProgressBar(0, frame.getWidth(), value=0, stringPainted=True)
        c = GridBagConstraints()
        c.fill = GridBagConstraints.HORIZONTAL
        c.weightx = 0.5
        c.gridwidth = 4
